...
impl BandwidthAllocator {
    ...
    pub fn allocate_bandwidth(&self, tenant_id: TenantId, requested: u64) -> Result<(), &'static str> {
        ...
        let available = self.total_bandwidth.saturating_sub(active_allocations.saturating_sub(current_allocation));
